...
def extract_structures( struct_db, rename_function = None ):
    args = [
        os.path.expanduser( '/home/oscar/software/rosetta_bin_linux_3.12_bundle/rosetta_bin_linux_2020.08.61146_bundle/main/source/bin/score_jd2.static.linuxgccrelease' ),
